...
layui.define(['jquery', 'layedit', 'jqdate','jqform', 'webuploader', 'layer'], function (exports) {
    var $ = layui.jquery,
    ...
    uploader.on('uploadSuccess', function (file, ret) {
        var imgName = ret.data.imgName;
        // console.log(imgName);
        var subImages = $("#subImages");
        if($("#productId").val() && entry == 0) {
            subImages.val("");
            entry ++;
        }
        if (subImages.val()) {
            subImages.val(subImages.val() + "," + imgName);
        } else {
            subImages.val(imgName);
        }
